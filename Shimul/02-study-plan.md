...
```mermaid
flowchart LR
    M["<b>Morning Block (3.0 Hrs)</b><br/>08:00 AM – 11:00 AM<br/>Heavy Conceptual Theory<br/>(KCS Act / Dairy / Constitution)"]
    A["<b>Afternoon Block (2.5 Hrs)</b><br/>02:00 PM – 04:30 PM<br/>Domain Application & Tables<br/>(FSSAI Standards, Regional GK, Kannada)"]
    E["<b>Evening Block (2.0 Hrs)</b><br/>07:30 PM – 09:30 PM<br/>Active Recall & Quizzing<br/>(quiz-bank.md & pyq-bank.md)"]
...
```mermaid
flowchart TD
    subgraph Stage1["Days 1–4: The 100-Mark Core Sprint"]
        D1["Day 1 (Sept 18): KCS Act 1959 Foundations<br/>History, Kanaginahal, Sec 1 to 28A"]
        D2["Day 2 (Sept 19): Enforcement & Constitutional 97th<br/>Sec 57, 63, 64, 69, 70 Disputes & SC 2021 Ruling"]
        D3["Day 3 (Sept 20): Dairy Movement & KMF/SHIMUL<br/>Anand 3-Tier, 16 Unions, Schemes (Ksheera Bhagya)"]
        D4["Day 4 (Sept 21): Dairy Science & Quality Standards<br/>FSSAI Fat/SNF, Pasteurization, Phosphatase test"]
    end

    subgraph Stage2["Days 5–7: High-Yield General & Language"]
        D5["Day 5 (Sept 22): Indian Constitution & Panchayati Raj<br/>FRs (12-35), DPSP 43B, Writs, 73rd Amdt (29 items)"]
        D6["Day 6 (Sept 23): Regional GK (SHIMUL Tri-District)<br/>Jog Falls, Obavva, Shanti Sagara, Guarantees"]
        D7["Day 7 (Sept 24): General Kannada & English<br/>ವ್ಯಾಕರಣ, ತತ್ಸಮ-ತದ್ಭವ, ಸಮಾಸಗಳು, Error Spotting"]
    end

    subgraph Stage3["Days 8–10: Revision, Mock Drills & Exam"]
        D8["Day 8 (Sept 25): Full Revision 1<br/>Re-read Subject Notes + Solve all 35 PYQs"]
        D9["Day 9 (Sept 26): Full Mock Test & Flashcard Sprint<br/>Timed Mock + Error Analysis + Early Sleep"]
        D10["Day 10 (Sept 27): EXAM DAY<br/>3-Round Tactical Strategy (Target: 155+ Marks)"]
    end

    Stage1 --> Stage2 --> Stage3

    style Stage1 fill:#fff7ed,stroke:#ea580c,stroke-width:2px
...
```mermaid
flowchart TD
    subgraph ThreeRounds["120-Minute Exam Hall Strategy"]
        direction TB
        R1["<b>Round 1 (First 60 Mins) — Confidence Surge</b><br/>• Attack Cooperation, Dairy & Constitution<br/>• Solve 100% sure questions only<br/>• Bubble immediately<br/>• <b>Bank 90–110 solid marks</b>"]
        
        R2["<b>Round 2 (Next 40 Mins) — Calculated Risk</b><br/>• Review 50:50 eliminated questions<br/>• Apply educated guess between 2 options<br/>• <b>Net positive expected value (+1 vs -0.25)</b>"]
        
        R3["<b>Round 3 (Last 20 Mins) — Audit & Protection</b><br/>• Check question numbering vs OMR bubble alignment<br/>• Strictly avoid blind wild guesses<br/>• <b>Protect hard-earned marks from negative penalty</b>"]
        
        R1 --> R2 --> R3
    end

    style ThreeRounds fill:#f8fafc,stroke:#334155,stroke-width:2px
