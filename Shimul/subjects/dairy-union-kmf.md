...
```mermaid
flowchart TD
    Apex["<b>STATE TIER: Apex Federation</b><br/>Karnataka Milk Federation (KMF - ಕರ್ನಾಟಕ ಹಾಲು ಮಹಾಮಂಡಳ)<br/>• Brand Ownership (Nandini)<br/>• State-wide Marketing, Inter-Union Balancing & Policy<br/>• Mega Powder Plants, Mother Dairy, Sperm Station"]
    
    Union["<b>DISTRICT TIER: District Milk Unions (16 in Karnataka)</b><br/>e.g., SHIMUL (Shivamogga, Davanagere, Chitradurga)<br/>• Processing Dairies & Bulk Milk Chilling Centers<br/>• Procurement Routes, Insulated Milk Tankers<br/>• Veterinary Hospitals, Mobile Clinics, AI & Cattle Feed"]
    
    DCS["<b>VILLAGE TIER: Primary Dairy Co-operative Societies (DCS)</b><br/>ಗ್ರಾಮ ಹಾಲು ಉತ್ಪಾದಕರ ಸಹಕಾರ ಸಂಘಗಳು<br/>• Daily Morning & Evening Milk Procurement from Farmers<br/>• Fat% & SNF Testing (Electronic Milk Analyzers & Lactometers)<br/>• Weekly / Direct DBT Bank Payments to Milk Producers<br/>• Cattle Feed & Fodder Seed Distribution"]

    Farmers["Rural Milk Producers / Farmer Members<br/>(Own Milch Animals & Pour Milk Daily)"]

    Apex -->|Technical Support & Brand Standard| Union
    Union -->|Procurement Routes & Inputs| DCS
    DCS -->|Direct Membership & Fair Payment| Farmers
    
    Farmers -.->|Elect Managing Committee| DCS
    DCS -.->|Presidents Elect Board of Directors| Union
    Union -.->|Chairmen Constitute Apex Board| Apex

    style Apex fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style Union fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style DCS fill:#dcfce7,stroke:#16a34a,stroke-width:2px
    style Farmers fill:#f3e8ff,stroke:#9333ea,stroke-width:2px
```
...
```mermaid
flowchart TD
    F["1. Farm Milking (Morning & Evening)"] --> DCS["2. Primary DCS Reception<br/>• Weighing<br/>• Gerber Fat Test<br/>• Lactometer Reading"]
    DCS --> BMC["3. Bulk Milk Cooler (BMC) / Chilling Center<br/>Chilled immediately below 4°C"]
    ...
    style DCS fill:#dcfce7,stroke:#16a34a,stroke-width:2px
    style BMC fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style Plant fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style Homo fill:#ede9fe,stroke:#7c3aed,stroke-width:2px
    style Past fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style QC fill:#fef08a,stroke:#ca8a04,stroke-width:2px
