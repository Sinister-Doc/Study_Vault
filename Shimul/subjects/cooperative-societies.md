...
```mermaid
flowchart TD
    Root["Karnataka Co-operative Societies Act, 1959"]
    
    subgraph PartA["1. Constitution & Membership"]
        A1["Sec 6 & 7: Registration (Min 10 persons)"]
        A2["Sec 12: Bye-law Amendment"]
        A3["Sec 16: Who may be Member"]
        A4["Sec 20: One Member, One Vote (No Proxy)"]
    end

    subgraph PartB["2. Governance & Management"]
        B1["Sec 27: AGM (Before Sept 25)"]
        B2["Sec 28A: Board Term 5 Years (Max 21)"]
        B3["Sec 28A Reservations: 1 SC, 1 ST, 2 Women, 1 BC"]
        B4["Sec 29G: Appointment of Chief Executive / MD"]
        B5["Sec 30 & 31: Supersession & Special Officer"]
    end

    subgraph PartC["3. Finance, Audit & Enforcement"]
        C1["Sec 57: Reserve Fund (Min 25% Net Profit)"]
        C2["Sec 63: Annual Audit (Dir of Co-op Audit)"]
        C3["Sec 64 & 65: Inquiry & Inspection by Registrar"]
        C4["Sec 69: Surcharge for Embezzlement"]
        C5["Sec 70: Disputes to Registrar (Civil Court Barred)"]
        C6["Sec 72: Winding Up & Dissolution"]
    end
    ...
    style Root fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style PartA fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style PartB fill:#dcfce7,stroke:#16a34a,stroke-width:2px
    style PartC fill:#fee2e2,stroke:#dc2626,stroke-width:2px
```
...
```mermaid
flowchart TD
    CA97["<b>97th Constitutional Amendment Act, 2011</b><br/>(Effective Feb 15, 2012)"]
    
    P1["<b>1. Article 19(1)(c)</b><br/>Fundamental Right to form<br/>co-operative societies"]
    P2["<b>2. Article 43-B (DPSP)</b><br/>State shall endeavour to promote<br/>autonomous co-operatives"]
    P3["<b>3. Part IX-B (Articles 243ZH to 243ZT)</b><br/>Detailed norms for Board size, term,<br/>reservations & independent audits"]

    CA97 --> P1
    CA97 --> P2
    CA97 --> P3

    SC["<b>Supreme Court Landmark Ruling (July 2021)</b><br/><i>Union of India vs. Rajendra N. Shah</i>"]
    P3 --> SC

    SC1["<b>Part IX-B Struck Down</b><br/>For State Co-operative Societies<br/>(Lacked 50% State Ratification under Art 368(2))"]
    SC2["<b>Part IX-B Upheld</b><br/>For Multi-State Co-operative Societies (MSCS)"]
    SC3["<b>Articles 19(1)(c) & 43B</b><br/>Remain 100% Valid & Intact"]

    SC --> SC1
    SC --> SC2
    SC --> SC3

    style CA97 fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    ...
    style SC fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style SC1 fill:#fecaca,stroke:#b91c1c,stroke-width:2px
    style SC2 fill:#bbf7d0,stroke:#15803d,stroke-width:2px
    style SC3 fill:#bbf7d0,stroke:#15803d,stroke-width:2px
```
...
```mermaid
flowchart TD
    D["Dispute Arises in Society<br/>(Business, Management, Election, Misappropriation)"] --> Q1{"Does it touch society affairs?"}
    
    Q1 -->|No| Civil["Ordinary Civil Court Jurisdiction"]
    Q1 -->|Yes| S70["<b>Section 70 of KCS Act 1959</b><br/>Referred strictly to Registrar<br/><b>Civil Courts completely barred</b>"]
    
    S70 --> S71["<b>Section 71 Hearing</b><br/>Disposal by Registrar or Nominee Arbitrator"]
    
    S71 --> Award["Arbitration Award / Decree Issued"]
    
    Award --> Appeal{"Aggrieved by Award?"}
    Appeal -->|Yes| KAT["Appeal to Karnataka Appellate Tribunal (KAT)<br/>under Section 106"]
    Appeal -->|No| Exec["Execution & Recovery as Arrears of Land Revenue"]

    subgraph EmbezzlementTrack["Embezzlement & Financial Fraud Track"]
        Inq["Sec 64 Inquiry or Sec 63 Audit Detection"] --> Sur["<b>Section 69 Surcharge Order</b><br/>Direct recovery from delinquent officers"]
    end

    style D fill:#f8fafc,stroke:#475569,stroke-width:2px
    style S70 fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style S71 fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style KAT fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style Sur fill:#fecaca,stroke:#b91c1c,stroke-width:2px
```
