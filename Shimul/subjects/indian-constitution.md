...
```mermaid
flowchart TD
    FR["Fundamental Rights (Part III, Articles 12–35)<br/><i>Enforceable directly through Courts (Justiciable)</i>"]
    
    R1["<b>1. Right to Equality (Art 14–18)</b><br/>• Art 14: Equality before law<br/>• Art 15: No discrimination<br/>• Art 16: Public employment<br/>• Art 17: Abolition of untouchability<br/>• Art 18: Abolition of titles"]
    
    R2["<b>2. Right to Freedom (Art 19–22)</b><br/>• Art 19: 6 Freedoms (19(1)(c) Co-ops)<br/>• Art 20: Protection against conviction<br/>• Art 21: Life & personal liberty<br/>• Art 21A: Right to Education (6-14 yrs)<br/>• Art 22: Arbitrary arrest protection"]
    
    R3["<b>3. Against Exploitation (Art 23–24)</b><br/>• Art 23: Human trafficking & begar<br/>• Art 24: Child labour under 14 years"]
    
    R4["<b>4. Freedom of Religion (Art 25–28)</b><br/>• Conscience, practice, propagation"]
    
    R5["<b>5. Cultural & Education (Art 29–30)</b><br/>• Protection of minority rights"]
    
    R6["<b>6. Constitutional Remedies (Art 32)</b><br/>• Heart & Soul of Constitution (Ambedkar)<br/>• 5 Prerogative Writs"]
    ...
    style FR fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    ...
    style R5 fill:#f3e8ff,stroke:#9333ea,stroke-width:2px
    style R6 fill:#fef08a,stroke:#ca8a04,stroke-width:2px
```
...
```mermaid
flowchart TD
    Violation["Violation or Infringement of Legal / Fundamental Right"] --> Check{"What is the nature of grievance?"}
    ...
    style Violation fill:#f8fafc,stroke:#475569,stroke-width:2px
    style W1 fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style W2 fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style W3 fill:#fef08a,stroke:#ca8a04,stroke-width:2px
    style W4 fill:#dbeafe,stroke:#2563eb,stroke-width:2px
    style W5 fill:#f3e8ff,stroke:#9333ea,stroke-width:2px
```
...
```mermaid
flowchart TD
    Gov["73rd Constitutional Amendment Act, 1992<br/>(Effective April 24, 1993 - National Panchayati Raj Day)<br/><b>Part IX (Articles 243 to 243-O) | 11th Schedule (29 Functional Subjects)</b>"]
    
    Zilla["<b>District Level: Zilla Panchayat (ZP)</b><br/>District planning, large rural schemes, budget allocation"]
    Taluk["<b>Intermediate Level: Taluk Panchayat (TP)</b><br/>Panchayat Samiti / Block coordination"]
    Gram["<b>Village Level: Gram Panchayat (GP)</b><br/>Grassroots planning, sanitation, rural roads, water supply"]
    ...
    style Gov fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style Zilla fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style Taluk fill:#dcfce7,stroke:#16a34a,stroke-width:2px
    style Gram fill:#f3e8ff,stroke:#9333ea,stroke-width:2px
    style Sub1 fill:#fee2e2,stroke:#dc2626,stroke-width:2px
```
