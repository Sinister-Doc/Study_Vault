...
```mermaid
flowchart TD
    State["<b>Karnataka River Basins & Dams</b>"]
    
    subgraph East["East-Flowing Systems (Bay of Bengal)"]
        K1["<b>Krishna River System</b><br/>• Tungabhadra (Tunga + Bhadra merge at Koodli)<br/>• Ghataprabha (Hidkal Dam)<br/>• Malaprabha (Renuka Sagara / Navilatirtha)<br/>• Almatti Dam (Lal Bahadur Shastri Sagara)"]
        
        K2["<b>Cauvery River System</b><br/>• Originates at Talakaveri (Kodagu)<br/>• KRS Dam (Sir MV / Mandya)<br/>• Hemavathi (Gorur Dam), Kabini Dam<br/>• Shivanasamudra Falls (Gaganachukki & Bharachukki)"]
    end

    subgraph West["West-Flowing Systems (Arabian Sea)"]
        W1["<b>Sharavathi River</b><br/>• Origin: Ambuthirtha (Thirthahalli)<br/>• <b>Jog Falls (253m / 4 cascades)</b><br/>• Linganamakki Hydroelectric Dam"]
        
        W2["<b>Varahi & Kali Rivers</b><br/>• Varahi: <b>Kunchikal Falls (Hosanagara)</b><br/>• Kali: Supa Dam (Uttara Kannada)<br/>• Netravathi: Dharmasthala to Mangaluru"]
    end

    State --> East
    State --> West

    style State fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
    style East fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style West fill:#dcfce7,stroke:#16a34a,stroke-width:2px
```
...
```mermaid
flowchart TD
    Tri["<b>SHIMUL Tri-District Operational Footprint</b>"]
    
    D1["<b>SHIVAMOGGA ('Gateway of Malnad')</b><br/>• SHIMUL Headquarters & Central Dairy (Machenahalli)<br/>• Jog Falls (Sharavathi River - 253m)<br/>• Koodli (Sacred Tunga + Bhadra confluence)<br/>• Linganamakki Dam (Sharavathi) & Bhadra Reservoir<br/>• Gudavi Bird Sanctuary (Soraba) & Mandagadde Island<br/>• Literary: Kuvempu (Kuppalli), U.R. Ananthamurthy (Melige)<br/>• History: Keladi Shivappa Nayaka ('Sist' revenue system)"]
    
    D2["<b>DAVANAGERE ('Manchester of Karnataka')</b><br/>• Davanagere Main Dairy (KMF Milk Processing Hub)<br/>• Historical textile, spinning & ginning mills legacy<br/>• <b>Shanti Sagara / Sulekere (Channagiri)</b><br/>  (2nd largest ancient artificial tank in Asia)<br/>• Famous Culinary Specialty: Davanagere Benne Dosa<br/>• Kunduvada Kere & Bathi Gudda"]
    
    D3["<b>CHITRADURGA ('Kallina Kote / Stone City')</b><br/>• Chitradurga Chilling Center & BMC Network<br/>• <b>The 7-Ringed Stone Fort (ಏಳು ಸುತ್ತಿನ ಕೋಟೆ)</b><br/>• <b>Legend of Onake Obavva (Pestle defense, 1779)</b><br/>• <b>Vani Vilasa Sagara / Mari Kanive Dam (Hiriyur)</b><br/>  (Oldest Dam in Karnataka across Vedavathi River, 1907)<br/>• Last ruler: Raja Veera Madakari Nayaka V<br/>• Major Windmill / Renewable energy center"]

    Tri --> D1
    Tri --> D2
    Tri --> D3

    style Tri fill:#e0f2fe,stroke:#0284c7,stroke-width:2px
...
```mermaid
flowchart LR
    subgraph Districts["SHIMUL Tri-District"]
        S["Shivamogga"]
        D["Davanagere"]
        C["Chitradurga"]
    end

    subgraph UniqueFacts["Distinctive Exam Fact"]
        F1["Jog Falls, Koodli Confluence, Linganamakki & Kuvempu"]
        F2["Manchester of Karnataka, Shanti Sagara & Benne Dosa"]
        F3["7-Ringed Fort, Onake Obavva & Vani Vilasa Sagara"]
    end
    ...
    style Districts fill:#f8fafc,stroke:#475569,stroke-width:2px
    style S fill:#dcfce7,stroke:#16a34a,stroke-width:2px
    style D fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style C fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style UniqueFacts fill:#f1f5f9,stroke:#64748b,stroke-width:2px
```
